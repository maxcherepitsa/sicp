...
(A 3 3)
; тут моего терпения не хватило : )


;Рассмотрим следующие процедуры, где A — процедура, определенная выше: (define (f n) (A 0 n))
...
; 2n
(define (g n) (A 1 n))
; а вот тут и в следующем не знаю ответа, не хватило математической смекалочки : (
(define (h n) (A 2 n))
(define (k n) (* 5 n n))
